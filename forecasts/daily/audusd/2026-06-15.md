...
(inside zone). SL = 0.70902 + 0.00247 = **0.71149** (above zone top 0.7110). lots **8.09** ($2000/R).
R = 0.00247. TP1 2.5R **0.70285** (manual) · TP2 3.0R **0.70161** (limit) · BE +1.5R **0.70532**.

```
AUDUSD ORDER LIMIT: SELL 0.70902 | 8.09 lots | SL 0.71149 | TP1 2.5R 0.70285 (manual) | TP2 3.0R 0.70161 (limit) | BE @1.5R 0.70532 | expires 2026-06-15 21:00 UTC
