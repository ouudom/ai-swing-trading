...
# Validation — 2026-06-08 (PRIMARY + SECONDARY zones from [[2026-W23]])
...
lots           = 2000 / (49.14 × 100) = 0.407 → 0.40 lots  (risk $1,965.60 / zone)
```
...
### ✅ ORDER LIMIT — PRIMARY
```
ORDER LIMIT: SELL $4417.81 | 0.40 lots | SL $4466.95 | TP1 2.5R $4294.96 (manual) | TP2 3.0R $4270.39 (limit) | BE @1.5R $4344.10 | expires 2026-06-08 21:00 UTC
...
```
ORDER LIMIT: SELL $4506.81 | 0.40 lots | SL $4555.95 | TP1 2.5R $4383.96 (manual) | TP2 3.0R $4359.39 (limit) | BE @1.5R $4433.10 | expires 2026-06-08 21:00 UTC
Entry Confluence: 6.0/10 (E0:❌ E1:✅ E2:✅ E3:✅ E4:❌ E5:✅)
...
**Week risk:** 2 × $1,965.60 = **$3,931.20** open (≤ $4,000 cap). 0 trades filled.
