...
lots           = 2000 / (46.45 × 100) = 0.431 → 0.43 lots  (risk $1,997.35 / zone)
```
...
### ✅ ORDER LIMIT — PRIMARY
```
ORDER LIMIT: SELL $4415.66 | 0.43 lots | SL $4462.11 | TP1 2.5R $4299.53 (manual) | TP2 3.0R $4276.31 (limit) | BE @1.5R $4345.98 | expires 2026-06-09 21:00 UTC
...
```
ORDER LIMIT: SELL $4504.66 | 0.43 lots | SL $4551.11 | TP1 2.5R $4388.53 (manual) | TP2 3.0R $4365.31 (limit) | BE @1.5R $4434.98 | expires 2026-06-09 21:00 UTC
Entry Confluence: 6.0/10 (E0:❌ E1:✅ E2:✅ E3:✅ E4:❌ E5:✅)
...
**Week risk:** 2 × $1,997.35 = **$3,994.70** open. 0 trades filled.
