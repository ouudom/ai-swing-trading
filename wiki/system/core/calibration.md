...
> **AUTO-GENERATED** by `scripts/calibration.py` at 2026-06-26 03:39Z. Do not hand-edit — re-run the script. Source: `data/zone_outcomes.csv`.

Zones tracked: **40** · completed shadow trades: **16** · invalidated-before-fill (capital saved): **0** · min-n for verdicts: **10**.

## Overall (completed shadow trades)

n=16 · win 19% · -4.5R (avg -0.28) · **DEAD**
...
|---|---|---|---|---|---|
| 7.0–7.9 | 5 | 20% | -1.5 | -0.30 | INSUFFICIENT (n<10) |
| <7.0 | 9 | 22% | -2.0 | -0.22 | INSUFFICIENT (n<10) |
| >=8.0 | 2 | 0% | -1.0 | -0.50 | INSUFFICIENT (n<10) |

### By instrument

| instrument | n | win% | total R | avg R | verdict |
|---|---|---|---|---|---|
| audusd | 1 | 100% | +2.5 | +2.50 | INSUFFICIENT (n<10) |
| eurgbp | 2 | 0% | -2.0 | -1.00 | INSUFFICIENT (n<10) |
| eurusd | 3 | 0% | -3.0 | -1.00 | INSUFFICIENT (n<10) |
| gbpusd | 4 | 25% | -0.5 | -0.12 | INSUFFICIENT (n<10) |
| nzdusd | 2 | 0% | -2.0 | -1.00 | INSUFFICIENT (n<10) |
| usdchf | 3 | 0% | -2.0 | -0.67 | INSUFFICIENT (n<10) |
| xauusd | 1 | 100% | +2.5 | +2.50 | INSUFFICIENT (n<10) |

### By direction

| direction | n | win% | total R | avg R | verdict |
|---|---|---|---|---|---|
| LONG | 7 | 0% | -7.0 | -1.00 | INSUFFICIENT (n<10) |
| SHORT | 9 | 33% | +2.5 | +0.28 | INSUFFICIENT (n<10) |

### By conviction

| conviction | n | win% | total R | avg R | verdict |
|---|---|---|---|---|---|
| MEDIUM | 11 | 27% | +0.5 | +0.05 | WORKING |
...
|---|---|---|---|---|---|
| Asia | 2 | 50% | +1.5 | +0.75 | INSUFFICIENT (n<10) |
| London | 5 | 20% | -1.5 | -0.30 | INSUFFICIENT (n<10) |
| NY | 9 | 11% | -4.5 | -0.50 | INSUFFICIENT (n<10) |
...
| eurgbp | SHORT | 1 | 0% | -1.0 | INSUFFICIENT (n<10) |
| eurusd | LONG | 2 | 0% | -2.0 | INSUFFICIENT (n<10) |
| eurusd | SHORT | 1 | 0% | -1.0 | INSUFFICIENT (n<10) |
| gbpusd | LONG | 1 | 0% | -1.0 | INSUFFICIENT (n<10) |
| gbpusd | SHORT | 3 | 33% | +0.5 | INSUFFICIENT (n<10) |
| nzdusd | LONG | 2 | 0% | -2.0 | INSUFFICIENT (n<10) |
| usdchf | LONG | 1 | 0% | -1.0 | INSUFFICIENT (n<10) |
| usdchf | SHORT | 2 | 0% | -1.0 | INSUFFICIENT (n<10) |
| xauusd | SHORT | 1 | 100% | +2.5 | INSUFFICIENT (n<10) |

## R2 — Entry Confluence (trade_outcome replay)

Replayed fills: completed **14** · LIMIT_MISSED (offset never reached = D030 near-miss) **9** · min-n **10**.
...
> D030 offset watch: **9** zones filled at the zone midpoint in `zone_outcome` but the entry-mechanics offset limit was never reached — the offset is leaving fills (often the winners) on the table.
